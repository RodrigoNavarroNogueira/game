...
import textwrap
import json
from classes.classes import Humano, Elfo, Criatura, Objeto, Npc, Item, criar_jogador
...
char = Jogador(1, 0, 'Navarro', 1.80, 30, 'Male')
varss = vars(char)
...
char2 = Jogador(2, 0, 'Elfo', 1.82, 500, 'Female')
varss = vars(char2)
